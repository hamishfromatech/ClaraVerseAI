      ...
      {memoryEnabled && !memoryStats && !memoryStatsError && (
        <div style={{ padding: '24px', textAlign: 'center', color: '#9CA3AF' }}>
          ...
          <p style={{ fontSize: '12px', marginTop: '4px' }}>
            Memories will be extracted as you chat with Blutone
          </p>
        </div>
      )}
            ...
            <div className="p-6 space-y-5 text-sm overflow-y-auto max-h-[calc(85vh-80px)]">
              ...
              <section>
                ...
                <p className="text-gray-400 leading-relaxed text-xs">
                  Blutone automatically extracts and stores key information from your conversations.
              ...
              <section>
                ...
                <div className="space-y-2 text-gray-400">
                  <ul className="space-y-1.5">
                    ...
                    <li className="flex items-start gap-2 text-xs">
                      <span className="text-gray-300/50 mt-0.5">•</span>
                      <span>Blutone Tech AI administrators cannot access your encrypted memories</span>
                    </li>
                    <li className="flex items-start gap-2 text-xs">
                      <span className="text-gray-300/50 mt-0.5">•</span>
