    ...
    <aside className="privacy-policy-sidebar">
      ...
      <div className="privacy-policy-sidebar-content">
        ...
        <section className="policy-summary">
          ...
          <p>
            We collect only what's necessary to provide Blutone Tech AI services. Your data is encrypted,
        ...
        <section className="policy-section">
          ...
          <ul>
            <li>To provide and operate Blutone Tech AI services</li>
        ...
        <section className="policy-section policy-contact">
          ...
          <a href="mailto:privacy@blutone.tech" className="policy-email-link">
            privacy@blutone.tech
          </a>
        </section>
