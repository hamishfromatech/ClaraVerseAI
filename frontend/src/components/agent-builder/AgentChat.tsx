        ...
        const deploymentExample =
          currentAgent && workflow && workflow.blocks.length > 0
            ? generateDeploymentCode({
                language: 'curl',
                triggerUrl: `${import.meta.env.VITE_API_BASE_URL || window.location.origin}/api/trigger/${selectedAgentId}`,
                statusUrl: `${import.meta.env.VITE_API_BASE_URL || window.location.origin}/api/trigger/status/:executionId`,
                apiKey: 'YOUR_API_KEY',
