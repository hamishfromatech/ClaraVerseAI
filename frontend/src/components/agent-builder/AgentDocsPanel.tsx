...
// Platform definitions for AI prompt generator - KaylahGPT first as featured option
const AI_PLATFORMS = [
  {
    id: 'kaylahgpt',
    name: 'KaylahGPT',
    // KaylahGPT uses Sparkles icon (rendered inline, not favicon)
    favicon: null,
    color: '#267C7E',
    description: 'Build instantly with KaylahGPT',
    featured: true,
  },
  {
    id: 'bolt',
...
## IMPORTANT: Output Format for KaylahGPT
...
## Requirements for KaylahGPT (Standalone HTML)
  ...
  return (
    <div className="p-6 space-y-6">
      ...
      <Section title="Build UI with AI" icon={<Sparkles size={16} />}>
        ...
        {/* KaylahGPT special action - Generate Now button */}
        {selectedPlatform === 'kaylahgpt' && (
          <div className="mt-3 pt-3 border-t border-[var(--color-border)]">
            <button
              onClick={() => {
                const prompt = generatePrompt('kaylahgpt');
